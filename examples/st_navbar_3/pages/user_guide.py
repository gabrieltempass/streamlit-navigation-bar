...
def show_user_guide():
	...
	st.write(
		...
		id sapien elementum, porta sem vitae, imperdiet lacus. Nunc id venenatis sem, 
		sit amet elementum diam. Maecenas mollis magna sed velit convallis faucibus. 
		Integer sit amet laoreet sapien, nec lobortis metus. Donec et felis mauris. 

		Sed felis orci, dictum vitae augue non, congue mollis lorem. Duis at porta 
		orci. Donec ac euismod nisl. Vestibulum neque libero, scelerisque a est et, 
		ornare vehicula ligula. Nullam semper neque auctor, tincidunt elit non, euismod 
		dui. Nunc suscipit urna massa, sed pellentesque est ultrices a. Quisque sit 
		amet dapibus orci. Pellentesque habitant morbi tristique senectus et netus et 
